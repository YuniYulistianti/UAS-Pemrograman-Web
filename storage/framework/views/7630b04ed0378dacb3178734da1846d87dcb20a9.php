<?php if (isset($component)) { $__componentOriginal51b6d672019b6213e429e90bd89b9af290b6a5c2 = $component; } ?>
<?php $component = App\View\Components\UtsLayout::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('uts-layout'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\UtsLayout::class))->getConstructor()): ?>
...
<?php $component->withAttributes([]); ?>
    ...
    <div class="container">
        ...
        <div class="py-6 w-full px-4 text-center md:w-1/2 lg:w-1/3">
            <img src="<?php echo e(url('img')); ?>/ident.png" alt="Identitas" class="mx-auto" />
        ...
        <div class="py-6 w-full px-4 text-center md:w-1/2 lg:w-1/3">
            <img src="<?php echo e(url('img')); ?>/visi.png" alt="Identitas" class="mx-auto" />
            <h2 class="font-bold text-xl text-three my-6">Visi Misi</h2>
            <p class="font-medium text-sm text-secondary mb-4">Hight School berdiri sejak tahun 1980 dengan nama Hight School 1. Sekolah yang akan membimbing muridnya hingga benar</p>
            <a href="#" class="font-semibold text-sm text-primary">Read more</a>
        </div>
        <div class="py-6 w-full px-4 text-center md:w-1/2 lg:w-1/3">
            <img src="<?php echo e(url('img')); ?>/struktur.png" alt="Identitas" class="mx-auto" />
    ...
    <div class="w-full lg:w-1/2">
        <img src="<?php echo e(url('img')); ?>/Frame.png" alt="" class="w-full" />
    </div>
    <div class="w-full py-4 px-4 lg:w-1/2">
        ...
        <img src="<?php echo e(url('img')); ?>/image 34.png" alt="Kepala sekolah" class="rounded-full mr-2" />
        <h4>
    ...
    <div class="container">
        ...
        <div class="container mb-28">
            ...
            <div class="w-full text-center py-6 px-4 border rounded-xl md:w-[48%]">
                <img src="<?php echo e(url('img')); ?>/ips.png" alt="IPS" class="mx-auto" />
            ...
            <div class="w-full text-center py-6 px-4 border rounded-xl md:w-[48%]">
                <img src="<?php echo e(url('img')); ?>/ipa.png" alt="IPS" class="mx-auto" />
        ...
        <div class="container mb-28">
            ...
            <div class="rounded-xl p-4 overflow-hidden w-full md:w-1/2 lg:w-1/3">
                <img src="<?php echo e(url('img')); ?>/bola.png" alt="bola" class="w-full" />
            </div>
            <div class="rounded-xl p-4 overflow-hidden w-full md:w-1/2 lg:w-1/3">
                <img src="<?php echo e(url('img')); ?>/batminton.png" alt="bola" class="w-full" />
            </div>
            <div class="rounded-xl p-4 overflow-hidden w-full md:w-1/2 lg:w-1/3">
                <img src="<?php echo e(url('img')); ?>/tenis.png" alt="bola" class="w-full" />
            </div>
            </div>
        </div>
        </section>
        ...
        <div class="lg:columns-2">
            ...
            <img src="<?php echo e(url('img')); ?>/artikel 1.png" alt="" class="h-full w-full" />
            ...
            <img src="<?php echo e(url('img')); ?>/artikel 2.png" alt="" class="lg:float-left mr-4" />
            ...
            <div class="mb-3 cursor-pointer">
            <img src="<?php echo e(url('img')); ?>/artikel 3.png" alt="" class="lg:float-left mr-4" />
            <div class="w-full py-3">
                <p class="text-sm font-medium text-slate-500">September 2, 2022</p>
    ...
    <div class="w-full text-center mb-14">
        ...
        <img src="<?php echo e(url('img')); ?>/galeri 4.png" alt="" />
        <img src="<?php echo e(url('img')); ?>/galeri 1.png" alt="" />
        <img src="<?php echo e(url('img')); ?>/galeri 2.png" alt="" />
        <img src="<?php echo e(url('img')); ?>/galeri 3.png" alt="" />
        <img src="<?php echo e(url('img')); ?>/galeri 5.png" alt="" />
        </div>
        <button type="button" class="button-primary">See more</button>
    </div>
    </section>
...
<?php endif; ?>
<?php if (isset($__componentOriginal51b6d672019b6213e429e90bd89b9af290b6a5c2)): ?>
<?php $component = $__componentOriginal51b6d672019b6213e429e90bd89b9af290b6a5c2; ?>
<?php unset($__componentOriginal51b6d672019b6213e429e90bd89b9af290b6a5c2); ?>
<?php endif; ?><?php /**PATH C:\xampp\htdocs\sample-laravel-9\resources\views/pages/home.blade.php ENDPATH**/ ?>