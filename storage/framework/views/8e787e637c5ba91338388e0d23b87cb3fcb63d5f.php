  ...
  <body>
    ...
    <section class="container mx-auto p-5 font-poppins">
        <div class="flex items-center justify-between">
          <div class="">
          <img src="<?php echo e(url('img')); ?>/Group 35.png" alt="logo" />
          </div>
        ...
        <section class="w-[1240px] mx-auto">
            <div class="container mx-auto flex items-center font-inter items-center justify-between">
              ...
              <div>
                ...
                <img src="<?php echo e(url('img')); ?>/Group 33.png" alt="" />
              </div>
              <div>
              ...
              <img src="<?php echo e(url('img')); ?>/Group 33.png" alt="" />
                ...
                <img src="<?php echo e(url('img')); ?>/image 6.svg" alt="" />
              </div>
            </div>
          </section>
          <Section class="py-14">
      ...
      <div class="grid grid-cols-3 gap-1 py-10 mx-20">
        <div class="w-[400px] relative">
          ...
          <div class="absolute flex bg-[#00000066] text-white font-light rounded-full py-2 px-6 right-14 top-4 items-center gap-1 text-[14px]"><img src="<?php echo e(url('img')); ?>/Star 1.svg" alt="" />(2.1k)</div>
          <div class="absolute flex gap-4 items-center text-white top-[160px] left-4 text-[15px] w-[25px]"><img src="<?php echo e(url('img')); ?>/Ellipse 61.svg" alt="" />Raphael</div>
          ...
          <img src="<?php echo e(url('img')); ?>/Rectangle 11.png" alt="" />
          <div class="absolute flex gap-2 text-white top-[180px] right-16 pl-64 text-[13px] items-center"><img src="<?php echo e(url('img')); ?>/Polygon 1.png" alt="" /><img src="Polygon 1.png" alt="" />20 video</div>
        </div>
        <!-- galeri 1 -->
        <div class="w-[400px] relative">
          <p class="absolute text-[#FF994F] bg-[#fff] text-[14px] rounded-full py-2 px-4 mx-4 my-4"><span class="font-bold">$25/</span>Course</p>
          <div class="absolute flex bg-[#00000066] text-white font-light rounded-full py-2 px-6 right-14 top-4 items-center gap-1 text-[14px]"><img src="<?php echo e(url('img')); ?>/Star 1.svg" alt="" />(3.5k)</div>
          <div class="absolute flex gap-4 items-center text-white top-[160px] left-4 text-[15px] w-[25px]"><img src="<?php echo e(url('img')); ?>/microna.png" alt="" />Microna</div>
          <p class="absolute top-44 left-14 text-white text-[14px] font-light">teacher</p>
          <h2 class="absolute font-bold top-32 left-4 text-white text-[18px]">Basic programming (HTML, CSS)</h2>
          <img src="<?php echo e(url('img')); ?>/Rectangle 12.png" alt="" />
          <div class="absolute flex gap-2 text-white top-[180px] right-16 pl-64 text-[13px] items-center"><img src="<?php echo e(url('img')); ?>/Polygon 1.png" alt="" /><img src="Polygon 1.png" alt="" />20 video</div>
        </div>
        <!-- galeri 1 -->
        <div class="w-[400px] relative">
          <p class="absolute text-[#FF994F] bg-[#fff] text-[14px] rounded-full py-2 px-4 mx-4 my-4"><span class="font-bold">$25/</span>Course</p>
          <div class="absolute flex bg-[#00000066] text-white font-light rounded-full py-2 px-6 right-14 top-4 items-center gap-1 text-[14px]"><img src="<?php echo e(url('img')); ?>/Star 1.svg" alt="" /><img src="Star 1.svg" alt="" />(4k)</div>
          <div class="absolute flex gap-4 items-center text-white top-[160px] left-4 text-[15px] w-[25px]"><img src="<?php echo e(url('img')); ?>/david.png" alt="" />Davidun</div>
          <p class="absolute top-44 left-14 text-white text-[14px] font-light">teacher</p>
          <h2 class="absolute font-bold top-32 left-4 text-white text-[18px]">Photography</h2>
          <img src="<?php echo e(url('img')); ?>/Rectangle 13.png" alt="" />
          <div class="absolute flex gap-2 text-white top-[180px] right-16 pl-64 text-[13px] items-center"><img src="<?php echo e(url('img')); ?>/Polygon 1.png" alt="" /><img src="Polygon 1.png" alt="" />20 video</div>
        </div>
      </div>
      <div class="mb-5 action flex mx-auto justify-center items-center gap-5">
        ...
        <div class="container flex mx-auto items-center font-inter items-center justify-between">
          ...
          <img src="<?php echo e(url('img')); ?>/Group 2222.png" alt="" />
          </div>
          <div class="container flex mx-auto items-center font-inter items-center justify-between">
          ...
          <div class="flex justify-between items-center mx-auto gap-4">
            <div class="px-10 ">
              ...
              <div class="grid grid-cols-2 w-[300px] gap-4 py-4">
                <div class="flex gap-2"><img src="<?php echo e(url('img')); ?>/14.png" alt="" />World-class</div>
                <div class="flex gap-2"><img src="<?php echo e(url('img')); ?>/14.png" alt="" />Flexible</div>
                <div class="flex gap-2"><img src="<?php echo e(url('img')); ?>/14.png" alt="" />Affordable</div>
                <div class="flex gap-2"><img src="<?php echo e(url('img')); ?>/14.png" alt="" />Job-relevan</div>
              </div>
              <div>
            ...
            <img src="<?php echo e(url('img')); ?>/Group 1966.svg" alt="" />
            </div>
          </div>
        </div>
            <!--  -->
      ...
      <div class="container mx-auto font-[inter] w-[1300px] px-10">
        <div class="flex justify-between items-center">
          ...
          <div class="relative h-52 w-52">
            <div class="absolute inset-y-20 left-10 w-[350px] max-lg:w-[150px] max-lg:-left-[300px]"><img src="<?php echo e(url('img')); ?>/Frame 11.svg" alt="" /></div>
          </div>
          <div class="relative h-52 w-52">
            <div class="absolute -inset-y-10 right-0 w-[350px] max-lg:w-[150px] max-lg:-left-[720px] max-lg:inset-y-8"><img src="<?php echo e(url('img')); ?>/Frame 11.svg" alt="" /></div>
          </div>
        </div>
      </div>
    ...
    <section>
      <div class="container mx-auto py-20 px-10 max-w-[1300px]">
        ...
        <div class="relative">
          <div class="absolute -top-[350px] right-0 z-20 w-[500px] max-lg:hidden"><img src="<?php echo e(url('img')); ?>/image 9.svg" alt="" /></div>
          <div class="absolute right-[150px] -top-[380px] w-[130px] max-lg:hidden"><img src="<?php echo e(url('img')); ?>/Group 33.png" alt="" /></div>
          <div class="absolute right-[500px] -top-[180px] w-[130px] max-lg:hidden"><img src="<?php echo e(url('img')); ?>/Group 33.png" alt="" /></div>
          <div class="absolute left-0 -top-[405px] max-lg:w-[150px] max-lg:-top-[293px]"><img src="<?php echo e(url('img')); ?>/Rectangle 151.svg" alt="" /></div>
          <div class="absolute left-0 -top-[405px] max-lg:w-[200px] max-lg:-top-[293px]"><img src="<?php echo e(url('img')); ?>/Rectangle 152.svg" alt="" /></div>
          <div class="absolute left-14 -top-[405px] max-lg:w-[200px] max-lg:-top-[293px]"><img src="<?php echo e(url('img')); ?>/Rectangle 153.svg" alt="" /></div>
        </div>
      </div>
    </section>
    </section>
    <footer class="py-50 px-50 bg-[#281900]">
      <div class="flex flex-wrap">
       <div class="mx-10 w-[300px]">
         ...
         <img src="<?php echo e(url('img')); ?>/Group 35.svg" alt="" />
         </div>
         ...
         <div class="flex flex-wrap py-10" >
         <img src="<?php echo e(url('img')); ?>/Vector.svg" alt="" class="mr-4"  />
         <img src="<?php echo e(url('img')); ?>/Vector (1).svg" alt="" class="mr-4"  />
         <img src="<?php echo e(url('img')); ?>/Vector (2).svg" alt="" class="mr-4"  />
         <img src="<?php echo e(url('img')); ?>/Vector (3).svg" alt="" class="mr-4"  />
         </div>
       </div>
       <div class="mt-10 ">
       ...
       <div class="mt-10 ml-12">
         ...
         <ul class="py-6 text-slate-400">
           ...
           <img src="<?php echo e(url('img')); ?>/Frame 31.png" alt="" class="mr-4"  />
     </div>
    <script src="./app.js"></script>
</html><?php /**PATH C:\xampp\htdocs\sample-laravel-9\resources\views/layouts/uts-layout.blade.php ENDPATH**/ ?>